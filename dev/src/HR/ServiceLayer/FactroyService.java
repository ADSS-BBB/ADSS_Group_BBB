...
//employee service
    ...
    public String addEmployeeRole(Integer id, String role,String licenseType) throws Exception{
        System.out.println(employeeService.addRole(id, role,licenseType));
        return "";
    }
